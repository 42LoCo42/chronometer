...
const blBox = document.getElementById("backlight");
let showOct = 1;
let showDec = 1;
let showHex = 1;
let black = "#383E42";
...
function drawEightsPair(x, value, twoDots) {
...
function drawEight(x, oct, dec, hex) {
    //  --A--
    // |     |
    // F     B
    // |     |
    ...
    for (let x in segments) {
        const colorID = ((octDigit[x] * showOct) << (1 * 0)) +
